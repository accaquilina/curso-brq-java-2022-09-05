...
//    private UsuarioService usuService;
    ...
    public ResponseEntity<List<UsuarioDTO>> fetchUsuariosByNomeByendereco(
            @PathVariable String nomeBusca,
            @PathVariable String emailBusca,
        ...
        // List<UsuarioDTO> list = usuService.fetchUsuariosByNomeAndEmail(nomeBusca, emailBusca);
        var list = usuService.fetchUsuariosByNomeAndEmailAndEndereco(nomeBusca, emailBusca, ruaBusca);
